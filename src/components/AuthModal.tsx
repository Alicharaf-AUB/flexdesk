...
export default function AuthModal({ isOpen, onClose, defaultTab = "login" }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-md bg-white rounded-[24px] overflow-hidden animate-fade-in-up"
        ...
        <div className="px-8 pt-8 pb-4">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit}>
                ...
                {tab === "signup" && (
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-[var(--radius-input)] border border-border-light bg-white text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all"
                    />
                  </div>
                )}
              ...
              <button
                type="submit"
                className="flex items-center justify-center gap-2 w-full py-3 mt-5 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-[var(--radius-button)] btn-press transition-colors"
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 py-2.5 rounded-[var(--radius-button)] border border-border-light hover:bg-surface-muted transition-colors text-sm font-medium text-text-primary"
                >
